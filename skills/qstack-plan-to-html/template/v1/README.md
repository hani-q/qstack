...
Plan-specific CSS for a prototype, diagram, or anything one document needs goes
...
Progress is read in points, not cards, for example "21 of 55 points," because a card count
...
gets the whole plan. That is exactly what happens in print, where the marks
